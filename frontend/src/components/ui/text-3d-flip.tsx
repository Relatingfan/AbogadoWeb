...
const CharBox = memo(
  ({
    ...
    >
      <span
        className={cn("relative h-[1.2em] backface-hidden inline-block", textClassName)}
      ...
      <span
        className={cn(
          "absolute top-0 left-0 h-[1.2em] backface-hidden inline-block",
          flipTextClassName
        )}
